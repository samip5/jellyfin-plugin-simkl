...
{
    /// <summary>
    /// Legacy playback progress scrobbler implementation.
    /// This is the original version using MarkAsWatched API and simple throttling.
    /// </summary>
    public class LegacyPlaybackScrobbler : IHostedService
    {
        private readonly ISessionManager _sessionManager; // Needed to set up de startPlayBack and endPlayBack functions
        private readonly ILogger<LegacyPlaybackScrobbler> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyPlaybackScrobbler"/> class.
        /// </summary>
        /// <param name="sessionManager">Instance of the <see cref="ISessionManager"/> interface.</param>
        /// <param name="logger">Instance of the <see cref="ILogger{LegacyPlaybackScrobbler}"/> interface.</param>
        /// <param name="simklApi">Instance of the <see cref="SimklApi"/>.</param>
        public LegacyPlaybackScrobbler(
            ISessionManager sessionManager,
            ILogger<LegacyPlaybackScrobbler> logger,
            SimklApi simklApi)
        {
